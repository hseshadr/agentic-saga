...
const summaries: Readonly<Record<string, string>> = {
  ...
  compensation_started: "Kernel entered deterministic compensation.",
  ...
  human_required: "The kernel stopped for human review.",
  ...
  saga_started: "The kernel started the recorded Saga.",
  terminal_assigned: "The kernel assigned a verified terminal state.",
};
        ...
        {storyEvents.map((item) => (
          <li key={item.event.event_id}>
            ...
            >
              ...
              <span className={styles.storySummary}>
                {summaries[item.event.event_type] ?? "Recorded ledger evidence."}
              </span>
